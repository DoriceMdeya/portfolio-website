          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-800 dark:text-white">mdeyadorice@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-800 dark:text-white">+255 712442916</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-800 dark:text-white">Iringa, Tanzania</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                ...
                {/* TikTok - dojm with butterfly and flower */}
                <a 
